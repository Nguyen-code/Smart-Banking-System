...
#include <unistd.h>stringToCurrency
#include <time.h>
...
public:
    ...
    Transaction(string transactionID, string sourceAccount, string destinationAccount, float amount)    : transactionID(transactionID), sourceAccount(sourceAccount), destinationAccount(destinationAccount), amount(amount) {}
